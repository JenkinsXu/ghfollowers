...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createTabBarController() -> UITabBarController {
        ...
        tabBarController.viewControllers = [
            ...
            createFavouriteNavigationViewController()
        ]
    ...
    func createFavouriteNavigationViewController() -> UINavigationController {
        let favouriteViewController = FavouriteViewController()
        favouriteViewController.tabBarItem = .init(tabBarSystemItem: .favorites, tag: 1)
        favouriteViewController.title = "Favorites"
